...
export const MOCK_SERVICES = [
  ...
  },
  {
    ...
    name: "Copy.ai",
    subtitle: "AI Copywriting",
    description: "Marketing copy and content in seconds",
    fullDescription: "Copy.ai uses advanced AI to help you write high-converting sales copy, product descriptions, blog posts, and social media content. With 90+ tools and templates, Copy.ai speeds up your content creation workflow.",
    category: "copywriting",
    price: "$49/month",
    rating: "4.7",
    icon: "✨",
    ...
    useCases: ["Sales copy", "Email campaigns", "Product descriptions", "Blog posts", "Ad copy"],
    website: "https://copy.ai",
    popularity: 8200,
